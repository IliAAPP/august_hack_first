                    ...
                    >
                        ...
                        <View style={{ marginTop: 50, marginLeft: 10 }}>
                            ...
                            >
                                ...
                                >
                                    <Image
                                        source={require("../../../../assets/green_battery.jpg")}
                            ...
                            >
                                ...
                                >
                                    <Image
                                        source={require("../../../../assets/yellow_battery.jpg")}
                                        style={{ width: 30, height: 30 }}
                                    />
                                    <Text
                                        style={{
                            ...
                            >
                                ...
                                >
                                    <Image
                                        source={require("../../../../assets/cord.png")}
                                        style={{ width: 30, height: 30 }}
                                    />
                                    <Text
                                        style={{
                                ...
                                <TouchableOpacity
                                    onPress={() =>
                                        navigation.navigate("FilterDeepScreen")
                                    }
                                >
                                    <Text
                                        style={{
                            ...
                            >
                                ...
                                >
                                    <Image
                                        source={require("../../../../assets/downloading.jpg")}
                                        style={{ width: 30, height: 30 }}
                                    />
                                    <Text
                                        style={{
